...
- 2.  Check completeness and correctness – By **anti_join()**
  ...
  - By checking missing names in **results_df** and **bakers_df**
    ...
    could be **Jo** in **bakers_df** by typing error. Therefore change
    the name to **Jo** by **mutate() and **ifelse()\*\* function.
...
- 3.  Merged into final dataset
  ...
  - Finally rearrange the order of variable and observations to make it
    more reasonable. In specific, I put personal information in front of
    competition results, and sorted the observation by name in ascending
    order.
