...
*   3. Merged into final dataset
    * Finally rearrange the order of variable and observations to make it more reasonable. In specific, I put personal information in front of competition results, and sorted the observation by name in ascending order.
